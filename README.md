...
class MohamedAhshaan:
    def __init__(self):
        ...
        self.university = "IIT Campus • RGU UK"
        self.location = "Colombo, Sri Lanka"
        self.focus = ["ML", "Deep Learning", "LLMs", "NLP", "Computer Vision"]
...
> Building impactful AI solutions that solve real problems.
...
| NLP & LLMs | REST APIs | Data Cleaning |
| Prompt Engineering | HTML/CSS/JS | Data Analysis |
| Computer Vision | Git/GitHub | Visualization |
...
<a href="https://wa.me/94742663484">
